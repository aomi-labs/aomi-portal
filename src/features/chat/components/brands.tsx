...
/**
 * Official brand marks — chains and wallets.
 * SVG paths mirror aomi/apps/shadcn-registry/src/components/icons/{chains,wallets},
 * rendered in each brand's official color (the registry uses currentColor).
 */
...
export const EthereumMark = markup(
  "0 0 24 24",
...
export const ArbitrumMark = markup(
  "0 0 24 24",
...
export const OptimismMark = markup(
  "0 0 24 24",
...
export const PolygonMark = markup(
  "0 0 24 24",
...
export const LineaMark = markup(
  ...
  { light: "#0891b2", dark: "#61dfff" },
);

export const MonadMark = markup(
  "0 0 23.5642 24",
...
export const SepoliaMark = markup(
  "0 0 24 24",
  '<path d="M12 1.5L4.5 12L12 16.5L19.5 12L12 1.5Z" fill="currentColor" opacity="0.35"/><path d="M12 16.5L4.5 12L12 22.5L19.5 12L12 16.5Z" fill="currentColor" opacity="0.55"/><circle cx="18" cy="6" r="3.5" fill="currentColor" opacity="0.18"/><circle cx="18" cy="6" r="3.5" stroke="currentColor" stroke-width="1"/><text x="18" y="7.5" text-anchor="middle" font-size="5" font-weight="bold" fill="currentColor">T</text>',
  "#9BA1A6",
);

export const SolanaMark = markup(
  "0 0 397.7 311.7",
  '<defs><linearGradient id="sol-grad" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stop-color="#9945FF"/><stop offset="100%" stop-color="#14F195"/></linearGradient></defs><path d="M64.6 237.9c2.4-2.4 5.7-3.8 9.2-3.8h317.4c5.8 0 8.7 7 4.6 11.1l-62.7 62.7c-2.4 2.4-5.7 3.8-9.2 3.8H6.5c-5.8 0-8.7-7-4.6-11.1l62.7-62.7z" fill="url(#sol-grad)"/><path d="M64.6 3.8C67.1 1.4 70.4 0 73.8 0h317.4c5.8 0 8.7 7 4.6 11.1l-62.7 62.7c-2.4 2.4-5.7 3.8-9.2 3.8H6.5c-5.8 0-8.7-7-4.6-11.1L64.6 3.8z" fill="url(#sol-grad)" opacity="0.7"/><path d="M333.1 120.1c-2.4-2.4-5.7-3.8-9.2-3.8H6.5c-5.8 0-8.7 7-4.6 11.1l62.7 62.7c2.4 2.4 5.7 3.8 9.2 3.8h317.4c5.8 0 8.7-7 4.6-11.1l-62.7-62.7z" fill="url(#sol-grad)" opacity="0.85"/>',
  "#9945FF",
);
...
/**
 * Solflare / Backpack / Glow — not in shadcn-registry wallets yet.
 * Hand-drawn marks matching each brand's public mark + color.
 */

export function SolflareMark({ size = 16, ...props }: BrandProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        d="M16 6.5c.4 3.2 1.4 5.6 3.2 7.4 1.8 1.8 4.2 2.8 7.4 3.2-3.2.4-5.6 1.4-7.4 3.2-1.8 1.8-2.8 4.2-3.2 7.4-.4-3.2-1.4-5.6-3.2-7.4-1.8-1.8-4.2-2.8-7.4-3.2 3.2-.4 5.6-1.4 7.4-3.2 1.8-1.8 2.8-4.2 3.2-7.4Z"
        fill="#FFFFFF"
      />
      <circle cx="16" cy="16" r="3.2" fill="#FC822B" />
    </svg>
  );
}
...
export function GlowMark({ size = 16, ...props }: BrandProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <circle cx="16" cy="16" r="16" fill="#AB6AFF" />
      <circle cx="16" cy="16" r="10.5" fill="#AB6AFF" stroke="#FFFFFF" strokeWidth="1.4" opacity="0.35" />
      <circle cx="16" cy="16" r="7" fill="#FFFFFF" opacity="0.22" />
      <path
        d="M16 8.2c2.4 2.8 3.6 5.4 3.6 7.8 0 2.4-1.5 4.4-3.6 4.4s-3.6-2-3.6-4.4c0-2.4 1.2-5 3.6-7.8Z"
        fill="#FFFFFF"
      />
      <circle cx="16" cy="21.6" r="1.4" fill="#FFFFFF" />
    </svg>
  );
}

/* ---------------------------- AI vendors ----------------------------- */
/* Paths from aomi/apps/shadcn-registry/src/components/icons/vendors */

export const AnthropicMark = markup(
  "0 0 40 40",
...
export const OpenAIMark = markup(
  "0 0 40 40",
...
export const GoogleMark = markup(
  "0 0 40 40",
...
export const MistralMark = markup(
  "0 0 40 40",
...
export const XAIMark = markup(
  ...
  { light: MONO_BRAND.light, dark: "#e8e8e8" },
);

export const KimiMark = markup(
  "0 0 24 25",
...
const CHAIN_MARKS: Record<string, (p: BrandProps) => React.ReactNode> = {
  ...
  polygon: PolygonMark,
  linea: LineaMark,
  "linea-sepolia": LineaMark,
  monad: MonadMark,
  "monad-testnet": MonadMark,
  sepolia: SepoliaMark,
  "solana-mainnet": SolanaMark,
  "solana-devnet": SolanaMark,
  "solana-testnet": SolanaMark,
  solana: SolanaMark,
};

/** Network id (fixtures) → brand mark. */
export function NetworkMark({ id, size = 14 }: { id: string; size?: number }) {
  const Mark = CHAIN_MARKS[id] ?? EthereumMark;
...
function vendorFromModelId(id: string): string {
...
const MODEL_MARKS: Record<string, (p: BrandProps) => React.ReactNode> = {
  auto: AutoMark,
...
/** Model id (fixtures) → vendor brand mark. Falls back to Auto spark. */
export function ModelMark({ id, size = 14 }: { id: string; size?: number }) {
  const vendor = vendorFromModelId(id);
  const Mark = MODEL_MARKS[vendor] ?? AutoMark;
  return <Mark size={size} />;
}
